...
var clearProjects = false;
var clearUsers = false;
var clearRatings = false;
...
.find()
.remove()
  .exec(onceClearProj); // callback to continue at

  models.User
  .find()
  .remove()
  .exec(onceClearAcc); // callback to continue at
  ...
  .exec(function (err) {
    clearRatings = true;
    if (clearProjects && clearUsers && clearRatings)
      mongoose.connection.close()
  }); // callback to continue at

// Step 3: load the data from the JSON file
function onceClearProj(err) {
